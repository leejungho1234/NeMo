...
from nemo.collections.llm.api import finetune, pretrain, import_ckpt
from nemo.collections.llm.gpt.data.mock import MockDataModule
from nemo.collections.llm.gpt.data.packed_sequence import PackedSequenceSpecs
from nemo.collections.llm.gpt.model.hf_exaone import Exaone35Config8B, ExaoneModel
...
def model() -> run.Config[pl.LightningModule]:
    ...
    Examples:
        ...
        Python API usage:
            ...
            >>> print(model_config)
    """
    return run.Config(ExaoneModel, config=run.Config(Exaone35Config8B))
